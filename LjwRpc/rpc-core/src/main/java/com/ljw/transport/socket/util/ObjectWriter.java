package com.ljw.transport.socket.util;
...
public class ObjectWriter {
    ...
    public static void writeObject(OutputStream outputStream, Object object, CommonSerializer commonSerializer) throws IOException{
        ...
        outputStream.write(intToBytes(commonSerializer.getCode()));
